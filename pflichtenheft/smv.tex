...
Diese überprüften Eigenschaften werden üblicherweise in einer \emph{temporalen
...
\end{verbatim}
Es werden zunächst zwei Variablen deklariert, eine boolesche \texttt{request}
...
sich der Wert von \texttt{state} abhängig vom aktuellen Zustand verändert.
Wie man sieht ist nichts über \texttt{request} ausgesagt; folglich kann diese
