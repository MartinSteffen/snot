...
\emph{temporalen Logik} beschrieben, in dieser ist es möglich Eigenschaften
...
wird beschrieben, wie sich der Wert von \texttt{state} abhängig vom
...
\emph{boolesche} Variablen besitzt, in diese Eingabesprache zu übersetzen.
