...
Methode \texttt{start\_modcheck} mit Parameter eines SFC's in
abstrakter Syntax. Rückgabe: \emph{noch zu klären}: entweder mittels
Ausnahme oder boolescher Wert. Auf jeden Fall wird der Gui der Zustand
zurückgegeben, in welchem die Verletzung auftritt. Wie die Gui darauf reagiert
