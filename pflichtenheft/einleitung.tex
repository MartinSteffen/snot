...
graphischen Analysewerkzeug für SFCs (\textit{\textbf{S}equential
...
als ein \emph{Paket} implementiert werden. Die \emph{optionalen} Aufgabe
sind sekundär und werden nur hinzugenommen, falls es mehr Gruppen als
