...
Semantik ist nur für \emph{gecheckte} Programme definiert (s.\ 
...
Zuständen der \emph{Prozesse} des Programmes: der globale Zustand ist also
das \emph{Produkt} der lokalen Zustände.  Ein lokaler Zustand eines
Prozesses besteht aus dem \emph{state,} in dem sich der Prozeß befindet
