...
\item Es wird dem Editor ein \emph{gesamtes Programm} (Klasse
  ...
  hat.\footnote{In einer früheren Version des Pflichtenheftes (siehe
    Version 3) wurde dem Editor nur einzelne Prozesse übergeben. Um die
...
\emph{vermittels} der Gui passiert, da ein Editor nur due Übersicht über
einen Prozess hat.
