...
\item \textbf{Makefile}: jedes Paket, d.h.\ die Wurzel des entsprechenden
  ...
  muß \texttt{make all} unterst"utzt werden, welche f"ur das Paket den Java
...
\item \textbf{Dokumentation:} Der \Java-Code soll sinnvoll kommentiert und
  ...
  Implementiereung noch virtuell ist (als stub), ob nur Teile der
  vereinbarten Funktionalit"at bereitstehen, ob die Funktionalit"at noch
